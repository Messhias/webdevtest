...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'state-inscription' =>  'inscrição estadual',
        'city-inscription'  =>  'inscrição municipal',
        'gender'            =>  'sexo',
        'ownername'         =>  'nome do(a) dono(a)',
        'ownerphone'        =>  'telefone do(a) dono(a)',
        'owner-email'       =>  'e-mail do(a) dono(a)',
        'owneremail'        =>  'e-mail do(a) dono(a)',
    ],
